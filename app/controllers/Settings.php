    ...
    function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'tax_ifood' => $this->input->post('tax_ifood'),
                'tax_ifood_fix' => $this->input->post('tax_ifood_fix'),
                'tax_card' => $this->input->post('tax_card'),
                'tax_card_fix' => $this->input->post('tax_card_fix'),
                'tax_giftcard' => $this->input->post('tax_giftcard'),
                'tax_giftcard_fix' => $this->input->post('tax_giftcard_fix'),
            );
