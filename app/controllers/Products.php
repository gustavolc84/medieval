...
class Products extends MY_Controller
{
    ...
    function get_products() {
        ...
        if ($this->Admin) {
            $this->datatables->select($this->db->dbprefix('products').".id as pid, ".$this->db->dbprefix('products').".image as image, ".$this->db->dbprefix('products').".code as code, ".$this->db->dbprefix('products').".name as pname, type, ".$this->db->dbprefix('categories').".name as cname, quantity, tax, tax_method, cost, price, img_slides, barcode_symbology", FALSE);
        } else {
            $this->datatables->select($this->db->dbprefix('products').".id as pid, ".$this->db->dbprefix('products').".image as image, ".$this->db->dbprefix('products').".code as code, ".$this->db->dbprefix('products').".name as pname, type, ".$this->db->dbprefix('categories').".name as cname, quantity, tax, tax_method, price, img_slides, barcode_symbology", FALSE);
        }
    ...
    function add() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                ...
                'img_slides' => $this->input->post('img_slides'),
                'flag_aditional' => $this->input->post('flag_aditional'),
                );
