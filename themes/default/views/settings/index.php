                            ...
                            <div class="col-lg-12">
                                <div class="well well-sm">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            Taxa iFood (%)
                                            <?= form_input('tax_ifood', $settings->tax_ifood, 'class="form-control" id="tax_ifood" required="required"') ?>
                                        </div>
                                        <div class="form-group">
                                            Taxa Cartão (%)
                                            <?= form_input('tax_card', $settings->tax_card, 'class="form-control" id="tax_card" required="required"') ?>
                                        </div>
                                        <div class="form-group">
                                            Taxa Cartão Loja (%)
                                            <?= form_input('tax_giftcard', $settings->tax_giftcard, 'class="form-control" id="tax_giftcard" required="required"') ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            Taxa iFood (Fixo R$)
                                            <?= form_input('tax_ifood_fix', $settings->tax_ifood_fix, 'class="form-control" id="tax_ifood_fix" required="required"') ?>
                                        </div>
                                        <div class="form-group">
                                            Taxa Cartão (Fixo R$)
                                            <?= form_input('tax_card_fix', $settings->tax_card_fix, 'class="form-control" id="tax_card_fix" required="required"') ?>
                                        </div>
                                        <div class="form-group">
                                            Taxa Cartão Loja (Fixo R$)
                                            <?= form_input('tax_giftcard_fix', $settings->tax_giftcard_fix, 'class="form-control" id="tax_giftcard_fix" required="required"') ?>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
