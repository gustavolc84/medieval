                                ...
                                <tr>
                                    ...
                                    if(!empty($sales)) {
                                        ...
                                        foreach($sales as $value) {
                                            ...
                                            $html = "<span class='text-warning'>". $value->tax."</span><br>".$value->discount."<br><span class='text-success'>".$value->total."</span><br><span style='border-top:1px solid #DDD; display:block;'>".$value->grand_total."</span><hr>";

                                            $payments = array("CC" => "fa-credit-card", "Cheque" => "fa-cutlery", "cash" => "fa-money", "gift_card" => "fa-gift");

                                            foreach ($value->payments as $key => $val) {

                                                $payment_type = $this->site->getPaymentsByID($key);

                                                $html .= "<span style='font-size:12px;display:block' title='".$payment_type->name."'><div class='pull-left'><i class='".$payment_type->icon."'></i></div> ".$val."</span>";
                                            }

                                            $array[$value->date] = $html;
                                        }
