<script>
	$(document).ready(function () {
		$('#SLData').dataTable({
            ...
            "aoColumns": [{"mRender":null}, {"mRender":hrld}, null, {"mRender":currencyFormat}, {"mRender":currencyFormat}, {"mRender":currencyFormat}, {"mRender":currencyFormat}, {"mRender":currencyFormat}, null, {"bSortable":false, "bSearchable": false}]
		});
	});
</script>
					...
					<div class="table-responsive">
						<table id="SLData" class="table table-striped table-bordered table-condensed table-hover">
							<thead>
								<tr class="active">
									<th>Pedido</th>
									<th style="width: 110px;"><?php echo $this->lang->line("date"); ?></th>
									<th style="width:150px; text-align:center;"><?php echo $this->lang->line("customer"); ?></th>
									...
									<th style="width:300px !important; text-align:center;"><?php echo $this->lang->line("actions"); ?></th>
								</tr>
							</thead>
							<tbody>
								<tr>
