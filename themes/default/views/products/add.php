                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('img_slides', $tm, set_value('img_slides'), 'class="form-control tip select2" id="img_slides"  required="required" style="width:100%;"'); ?>
                                </div>

                                <div class="form-group">
                                    <?= 'Produto Adicional' ?>
                                    <?php $tm = array(0 => 'Não', 1 => 'Sim'); ?>
                                    <?= form_dropdown('flag_aditional', $tm, set_value('flag_aditional',0), 'class="form-control tip select2" id="flag_aditional" style="width:100%;"'); ?>
                                </div>
