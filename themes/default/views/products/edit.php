                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <?= lang('img_slides', 'img_slides'); ?>
                                    <?php $tm = array(0 => lang('slides_no'), 1 => lang('slides_yes')); ?>
                                    <?= form_dropdown('img_slides', $tm, set_value('img_slides',$product->img_slides), 'class="form-control tip select2" id="img_slides" style="width:100%;"'); ?>
                                </div>

                                <div class="form-group">
                                    <?= 'Produto Adicional'; ?>
                                    <?php $tm = array(0 => 'Não', 1 => 'Sim'); ?>
                                    <?= form_dropdown('flag_aditional', $tm, set_value('img_slides',$product->flag_aditional), 'class="form-control tip select2" id="flag_aditional" style="width:100%;"'); ?>
                                </div>
