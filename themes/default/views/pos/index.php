			...
			<nav class="navbar navbar-static-top" role="navigation">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<li class="hidden-xs"><a href="<?= site_url(); ?>visor" target="_blank"><i class="fa fa-desktop"></i></a></li>
						<?php if($Admin) { ?>
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview" id="mm_products">
						...
						<ul class="treeview-menu">
							...
							<li class="treeview" id="mm_payment_types">
								<a href="#">
									<i class="fa fa-credit-card"></i>
								...
								<ul class="treeview-menu">
									<li id="payment_types_index"><a href="<?= site_url('payment_types'); ?>"><i class="fa fa-circle-o"></i> Listar Formas</a></li>
									<li id="payment_types_add"><a href="<?= site_url('payment_types/add'); ?>"><i class="fa fa-circle-o"></i> Adicionar Forma</a></li>
								</ul>
							</li>
					...
					<table style="width:100%;" class="layout-table">
						<tr>
							<td style="width: 460px;">
								...
								<div id="pos">
									<?= form_open('pos', 'id="pos-sale-form" target="_blank"'); ?>
											...
											<div class="form-group" style="margin-bottom:5px;">
												<div class="input-group">
													<?php foreach($customers as $customer){ 
														...
														if($customer->phone) {
															$cus[$customer->id] = $customer->name." - ".$customer->phone; 	
														} else {
                      ...
                      <div class="form-group" style="margin-bottom:5px;">
                        <input type="text" name="cliente_loja" id="cliente_loja" class="form-control" placeholder="Cliente Loja" />
                      </div>
											<div class="form-group" style="margin-bottom:5px;">
										...
										<input type="hidden" name="entrega" value="0" id="entrega">
										<input type="hidden" id="tp_categoria">
										...
										<div id="payment-con">
											...
											<input type="hidden" name="paid_by" id="paid_by_val" value="2"/>
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-sm-6">
						...
						<div class="form-group">
							<?=lang('item_note', 'nItemNote')?>
							<textarea class="form-control input-sm" id="nItemNote" name = "nItemNote" placeholder="<?=lang('item_note')?>"></textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
						...
						<div class="form-group div_flavors" style="display:none;">
                            <?= lang('flavors','nFlavor'); ?>
                            <?php $opts = $flavors; ?>
                            <?= form_dropdown('nFlavor', $opts, set_value('flavors'), 'class="form-control input-sm kb-pad select2" id="nFlavor" style="width:100%;"'); ?>
                        </div>

                        <div class="form-group div_additional" style="display:none;">                        	
                            <?= lang('additional','nAdicionais'); ?> 
					...
					<div class="col-xs-9">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group">
									<?= lang('note', 'note'); ?>
									<textarea name="note" id="note" class="pa form-control kb-text text_info"></textarea>
								</div>
							</div>
							<div class="col-xs-12">
								<div class="form-group">
									<div class="checkbox checkbox-entrega">									  
										<label style="padding-left:0;margin-right:6px"><input name="entrega_viagem" style="" type="radio" value=""><b style="margin-left:10px">Entrega</b></label>
										<label style="padding-left:0;margin-right:6px"><input name="entrega_viagem" style="" type="radio" value=""><b style="margin-left:10px">Viagem</b></label>
									</div>
								</div>
							</div>
							<style>
								.checkbox-entrega .icheckbox_square-green {
									pointer-events:none;
								}

								.checkbox-entrega .iradio_square-green {
									pointer-events:none;
								}
							</style>
							<div class="col-xs-6">
						...
						<div class="row">
							...
							<div class="pcheque" style="display:none;">
								<div class="form-group">Pedido iFood
				...
				<div class="row">
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							<?= form_input('phone', '', 'class="form-control input-sm kb-pad" id="cphone" data-inputmask="\'mask\': \'99-9999999\'" ');?>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="form-group">
							...
							<?= form_input('address', '', 'class="form-control input-sm kb-text" id="address"'); ?>
						</div>
					</div>
					<div class="col-xs-12">
						<div class="form-group">
							...
							<?= form_textarea('obs', '', 'class="form-control input-sm kb-text" id="obs" rows="3"');?>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#editItem').click(function(){
			...
			$('#nItemNote').val('');
			$('input[name="nAdicionais[]"]').each(function(){
